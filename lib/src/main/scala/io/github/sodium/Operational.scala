...
object Operational {
  ...
  /**
    ...
    * initiated transaction. Same as [[io.github.sodium.Operational.split* split(Stream)]] but it works on a single value.
    */
  ...
  /**
    ...
    * events output by split() or [[io.github.sodium.Operational.defer* defer(Stream)]] invoked elsewhere in the code.
    */
